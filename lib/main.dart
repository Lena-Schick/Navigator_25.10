...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Align(
            alignment: Alignment.centerLeft, child: Text("HomeScreen")),
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: const Align(
              alignment: Alignment.centerLeft, child: Text("DetailsScreen"))),
      body: Center(
        child: Column(
